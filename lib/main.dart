...
import 'package:speechlist/screens/discussion_room.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        ...
        DiscussionRoomPage.routeName: (BuildContext context) => DiscussionRoomPage(room: ModalRoute.of(context).settings.arguments),
      },
    );
  }
}
